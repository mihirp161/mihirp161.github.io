...
mathjax: "true"
---
R is a tool for doing serious statistics and data analysis. But not everything in life can be serious, life is also beautiful, and R can make beautiful things too. R can make art like [here](https://toadhanks.github.io/julia/), [here](https://toadhanks.github.io/barnsleysFern/) or [here](https://toadhanks.github.io/mandelbrot/). But today, I wanted to create a flower for the Valentine's Day, and dedicate it to Joséphine Jobert and Fatima Sana Shaikh.

A rather short **source code** of today's post is [here](https://github.com/ToadHanks/marigold-phyllotaxis_R)!
...
Without boring you the reader or my love Joséphine & Fatima (Hi! if you're reading this), here is the marigold I've made for them-
...
flower_plot + geom_point(size= 80, alpha= 0.1, shape= 1, color= "based on your prefrence")+
